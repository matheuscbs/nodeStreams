...
const server = Duplex({
  ...
  read() {
    const everySecond = (intervalContext) => {
      ...
      if (this.counter++ <= 5) {
        this.push(`My name is Matheus[${this.counter}]`);
        return;
      }
...
// write triggers the writable stram from our duplex
...
// the push method ignore will ignore what you have in the transform function
